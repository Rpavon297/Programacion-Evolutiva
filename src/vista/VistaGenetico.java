...
public class VistaGenetico extends JFrame {
	...
	private static Plot2DPanel panelMathPlot;
	...
	public VistaGenetico() {
		...
		panelParams.setBounds(0, 0, 275, 660);
		...
		spinnerFunc.setBounds(178, 115, 87, 27);
		...
		spinnerPoblacion.setBounds(178, 164, 87, 27);
		...
		labelGeners.setBounds(10, 204, 168, 19);
		...
		spinnerGeners.setBounds(178, 202, 87, 27);
		...
		comboSeleccion.setBounds(97, 251, 168, 27);
		...
		comboCruce.setBounds(97, 285, 168, 27);
		...
		spinnerCruces.setBounds(181, 334, 58, 27);
		...
		percent1.setBounds(249, 336, 16, 19);
		...
		labelMutaciones.setBounds(10, 374, 168, 19);
		panelParams.add(labelMutaciones);
		
		spinnerMutaciones = new JSpinner();
		spinnerMutaciones.setBounds(181, 372, 58, 27);
		...
		spinnerPrecision.setBounds(178, 410, 61, 27);
		...
		labelDec.setBounds(249, 412, 25, 19);
		...
		chckbxElitismo.setBounds(10, 461, 94, 23);
		panelParams.add(chckbxElitismo);
		
		spinnerElitismo = new JSpinner();
		spinnerElitismo.setBounds(178, 461, 61, 27);
		...
		percent3.setBounds(249, 467, 16, 14);
		...
		panelMathPlot.plotCanvas.setBounds(0, 25, 784, 581);
		panelMathPlot.plotCanvas.setLayout(null);
		panelMathPlot.plotToolBar.setBounds(0, 0, 784, 25);
		panelMathPlot.getPlotToolBar().setBounds(0, 0, 784, 25);
		panelMathPlot.setBounds(274, 0, 784, 606);
		contentPane.add(panelMathPlot);
		panelMathPlot.setLayout(null);
		
		JPanel panelNombres = new JPanel();
		panelNombres.setBounds(274, 639, 784, 21);
		...
		panel.setBounds(274, 603, 784, 35);
